...
public class ControllerModifierMarqueGyropode {
    private Stage stage;
    private Scene scene;
    private Parent root;
    public Label erreur;
    ...
    private MarqueGyropode marqueAModifier = null;


    //INITIALIZER
    public void initData(MarqueGyropode marque) {
        //obtenir l'objet Marque
        marqueAModifier = marque;

        nomForm.setText(marque.getNom());
        siteWebForm.setText(marque.getSiteWeb());
        nomCommercialForm.setText(marque.getNomCommercial());
        telCommercialForm.setText(marque.getTelCommercial());
        mailCommercialForm.setText(marque.getMailCommercial());
        nomSAVForm.setText(marque.getNomSAV());
        telSAVForm.setText(marque.getTelSAV());
        mailSAVForm.setText(marque.getMailSAV());
    }
    ...
    public void modifierUneMarqueGyropode(ActionEvent event) throws IOException{
        ...
        Gestionnaire.modifierMarqueDesGyropodes(marqueAModifier, nom, siteWeb, nomCommercial, telCommercial, mailCommercial, nomSAV, telSAV, mailSAV);
